    ...
    return (
        <Form layout="vertical" onFinish={onFinish} >
            ...
            <Form.Item
                label="Status"
                name="status"
                rules={[{ required: true, message: 'Please select the worker status' }]}
                style={{  width: '46%' }}
            >
                <Select>
            ...
            <Form.Item label="Person Information" style={{ marginBottom: 0 }}>
                ...
                <Form.Item
                    ...
                    label="Passport ID"
                    rules={[{ required: true, message: 'Please input the passport ID' }]}
                ...
                <Form.Item
                    ...
                    label="Eye Color"
                    rules={[{ required: true, message: 'Please select the eye color' }]}
                    style={{ display: 'inline-block', width: 'calc(50% - 8px)' }}>
                    <Select>
                ...
                <Form.Item
                    ...
                    label="Hair Color"
                    rules={[{ required: true, message: 'Please select the hair color' }]}
                    style={{ display: 'inline-block', width: 'calc(50% - 8px)', marginLeft: '16px' }}>
                    <Select>
                        <Option value="RED">RED</Option>
